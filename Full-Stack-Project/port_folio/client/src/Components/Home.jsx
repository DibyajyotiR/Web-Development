...
const Home = () => {
  return (
    <div id='home' className='bg-black font-bold text-white px-10 md:px-10 xl:px-16 py-20 md:py-20 xl:py-30 mt-4'>
      <div className='flex flex-col-reverse md:flex-row gap-16 py-6 justify-center items-center'>
        {/* home */}
        <div className='flex flex-col gap-4 w-full md:w-1/2  '>
          <h2 className='text-2xl md:text-2xl lg:text-3xl font-bold text-blue-400 drop-shadow-[0_0_15px_rgba(59,130,246,0.8)]'>ASPIRING FULL STACK DEVELOPER</h2>

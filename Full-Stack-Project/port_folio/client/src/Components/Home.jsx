    ...
    <div id='home' className='bg-black font-bold text-white px-10 md:px-10 xl:px-16 py-20 md:py-20 xl:py-30 mt-4 min-h-[80vh]'>
      <div className='flex flex-col-reverse md:flex-row gap-16 py-6 justify-center items-center'>
        ...
        <div data-aos="fade-right"
             className='flex flex-col gap-4 w-full md:w-1/2 lg:ml-15 '>
          <h2 data-aos="zoom-in" data-aos-delay="200"
              className='text-2xl md:text-2xl lg:text-3xl font-bold text-blue-400 drop-shadow-[0_0_15px_rgba(59,130,246,0.8)]'>ASPIRING MERN STACK DEVELOPER</h2>
          <p className='text-blue-300 text-sm md:text-base xl:text-lg '>Passionate about creating modern and scalable web applications using React, Node.js, Express.js, and MongoDB with clean and efficient code.</p>
            <div className=' bg-blue-300/10  flex items-center gap-2  w-fit border border-blue-500
             cursor-pointer px-4 py-2 
             transition-all duration-200
              hover:text-blue-400
             active:scale-95 rounded-xl
             focus:outline-none'>Resume <FiDownload className=' mt-1 h-4 '/>
            </div>

          
        </div>
        <div data-aos="fade-left"  className=' relative flex justify-center w-full md:w-1/2'>

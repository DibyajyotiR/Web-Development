...
const Skills = () => {
  ...
  {/* FRONTEND */}
        <div>
         ...
         <div className="border border-gray-500 rounded-xl bg-gradient-to-br from-gray-900 via-blue-900/20 to-green-900/10 grid grid-cols-2  lg:grid-cols-4
  ...
  {/* BACKEND */}
        <div>
          ...
          <div className="border rounded-xl border-gray-500 bg-gradient-to-l from-gray-900 via-blue-900/20 to-green-900/10 grid grid-cols-2  lg:grid-cols-4
  ...
  {/* DATABASE */}
        <div>
          ...
          <div className="border border-gray-500 rounded-xl bg-gradient-to-br from-gray-900 via-blue-900/20 to-green-900/10 grid grid-cols-2 
